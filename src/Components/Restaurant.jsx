...
const Restaurant = () => {
  ...
  return (
    <>
      <div className=' min-h-screen mb-20 font-gilroy'>
        <ResNavbar />
        ...
        {sliderData &&
          <div className=' w-[80vw] h-auto mx-auto mt-10 bg-white'>
            ...
            <div className='mt-5 mb-10'>
              ...
              <div className='grid grid-cols-4 gap-4' >
                {
                  cuisines && (isExpandedCuisines === true ? cuisines : cuisines.slice(0, 11)).map((item) => {
      ...
      <footer className=' bg-[#F0F0F5] w-[100%] font-gilroy'>
      ...
      <hr className="border border-[rgba(2,6,12,.50)]" />
          {
            ...
            (
              <div className='flex justify-between gap-7 items-center mt-10'>
                <h1 className='text-[26px] text-gray-800 font-bold leading-7'  >{bestExp.title}</h1>
                <div className='flex items-center'>
                  <a href={bestExp.androidAppLink} target='_blank' ><img src={playStore} className='w-[170px] transition-transform duration-200 hover:scale-105 ' /></a>
                  <a href={bestExp.iosAppLink} target='_blank'><img src={appStore} className='w-[200px] transition-transform duration-200 hover:scale-105' /></a>
                </div>
              </div>
            )
          }
            ...
            <div className="max-w-7xl mx-auto grid grid-cols-4 gap-6 text-sm">
              ...
              <div>
                ...
                <ul className="space-y-1 text-[16px] font-medium text-gray-600 ">
                  ...
                  <li><a>Swiggy Dineout</a></li>
                  <li><a>Swiggy Genie</a></li>
                  <li><a>Minis</a></li>
                  <li><a>Pyng</a></li>
              ...
              <div className="flex flex-col justify-between">
                ...
                <div className="mt-5">
                  <h2 className="font-bold mb-2 mt-[100px] text-[17px]">Legal</h2>
                  <ul className="space-y-1 text-[16px] font-medium text-gray-600">
              ...
              {/* Available in */}
              <div>
                <h2 className="font-bold mb-2 text-[17px]">Available in:</h2>
                <ul className="space-y-1 text-[16px] text-gray-600">
                  {resCities && resCities.slice(0, 6).map((item) => {
                    return (
                      <li className='font-medium'  key={item.text}><a>{item.text}</a></li>
                    )
                  })}
                ...
                <button
                  ...
                  className='border-[1.5px] rounded-xl px-2 py-1  border-gray-200 mt-2 flex items-center'>
                  <p className='text-[16px] text-gray-600 font-medium'>679 cities</p>
                  <svg
                    className={`ml-4 mt-1 transition-transform duration-400 ${isExpandedCities ? '' : 'rotate-180'}`}
                    xmlns="http://www.w3.org/2000/svg"
                    width="15"
                    height="15"
                    viewBox="0 0 24 24"
              ...
              <div className="h-[75%] flex flex-col justify-between">
                <div className=''>
                  <h2 className="font-bold mb-2 text-[17px]">Life at Swiggy</h2>
                  <ul className="space-y-1 text-[16px] font-medium text-gray-600">
                    <li><a>Explore with Swiggy</a></li>
                    <li><a>Swiggy News</a></li>
                  ...
                  <div className="">
                  <h2 className="font-bold text-[17px]  mb-2">Social Links</h2>
